export const getMaticTokenLogoURL = (address: string) => {
    let uri
    if (address?.toLowerCase() === '0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270') {    // WMATIC
    ...
    if (address?.toLowerCase() === '0x2791bca1f2de4661ed88a30c99a7a9449aa84174') {    // USDC
        address = '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48'
    }
    if (address?.toLowerCase() === '0x1bfd67037b42cf73acf2047067bd4f2c47d9bfd6') {    // WBTC
      address = '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599'
    }
    if (address?.toLowerCase() === '0x0be3afd0a28f0aa787d113c08d1d8a903cf6eee9') {    // FESW@M
        uri = 'https://www.feswap.io/img/Fesw.png'
    }
    if (address?.toLowerCase() === '0xb33eaad8d922b1083446dc23f610c2567fb5180f') {    // UNI
